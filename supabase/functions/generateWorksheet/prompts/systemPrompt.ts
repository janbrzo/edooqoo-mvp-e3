/**
 * Core system prompt with general guidelines and rules
 * CRITICAL: This content must match exactly with the original prompt
 */

export function getSystemPromptCore(hasGrammarFocus: boolean, grammarFocus: string = '', formData: any = {}, exerciseCount: number = 8): string {
