...
export const getMultipleChoiceExercise = () => `    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "nano_skill": [{"name": "ns.A2.comparatives.short_adjective_spicier", "confidence": 0.94, "reason": "Tests -ier comparative form"}]
        },
        {
        ...
        },
        {
          ...
          "nano_skill": [{"name": "ns.B1.comparatives.adverb_regular_more_slowly", "confidence": 0.93, "reason": "Tests 'more + adverb' comparative form"}]
        },
        {
...
export const getDiscussionExercise = () => `    {
      ...
      "questions": [
        {"text": "What is your favorite type of restaurant and why?", "nano_skill": [{"name": "ns.A2.speaking.opinion_expression", "confidence": 0.60, "reason": "Tests ability to express and justify personal preferences"}, {"name": "ns.A2.writing.opinion_justification", "confidence": 0.90, "reason": "Tests written opinion with justification"}]},
        {"text": "Have you ever had a bad experience in a restaurant? What happened?", "nano_skill": [{"name": "ns.A2.speaking.narrating_past_experience", "confidence": 0.60, "reason": "Tests past tense narrative and sequencing"}, {"name": "ns.A2.writing.past_tense_narrative", "confidence": 0.90, "reason": "Tests written past tense narrative"}]},
        {"text": "Do you prefer eating at home or dining out? Give reasons using comparatives.", "nano_skill": [{"name": "ns.A2.speaking.comparison_and_contrast", "confidence": 0.60, "reason": "Tests comparative structures in speech"}, {"name": "ns.A2.writing.comparative_response", "confidence": 0.90, "reason": "Tests written comparative reasoning"}]},
        {"text": "What dish would you recommend to someone visiting your country for the first time?", "nano_skill": [{"name": "ns.A2.speaking.giving_recommendation", "confidence": 0.60, "reason": "Tests recommendation language"}, {"name": "ns.A2.writing.recommendation_structure", "confidence": 0.90, "reason": "Tests written recommendation"}]},
        {"text": "Which restaurant in your city is the most popular? Why do you think it's the best?", "nano_skill": [{"name": "ns.A2.speaking.justifying_preference", "confidence": 0.60, "reason": "Tests superlative usage and justification"}, {"name": "ns.A2.writing.superlative_justification", "confidence": 0.90, "reason": "Tests written superlative justification"}]},
        {"text": "How do you usually react if your order is wrong or the food isn't good?", "nano_skill": [{"name": "ns.B1.speaking.describing_reaction", "confidence": 0.55, "reason": "Tests conditional/habitual reaction description"}, {"name": "ns.B1.writing.conditional_response", "confidence": 0.90, "reason": "Tests written conditional response"}]},
        {"text": "What is more important to you: good food or good service? Why?", "nano_skill": [{"name": "ns.B1.speaking.comparison_and_contrast", "confidence": 0.55, "reason": "Tests argumentative comparison"}, {"name": "ns.B1.writing.comparative_argument", "confidence": 0.90, "reason": "Tests written comparative argument"}]},
        {"text": "Can you describe the most expensive meal you've ever had? Was it worth it?", "nano_skill": [{"name": "ns.B1.speaking.narrating_past_experience", "confidence": 0.55, "reason": "Tests detailed past narrative with evaluation"}, {"name": "ns.B1.writing.descriptive_narrative", "confidence": 0.90, "reason": "Tests written descriptive narrative"}]},
        {"text": "What makes a restaurant better than others in your opinion?", "nano_skill": [{"name": "ns.B1.speaking.justifying_preference", "confidence": 0.55, "reason": "Tests analytical comparison and justification"}, {"name": "ns.B1.writing.comparative_argument", "confidence": 0.90, "reason": "Tests written comparative argument"}]},
        {"text": "Have you ever tried a dish that was better than you expected? What was it?", "nano_skill": [{"name": "ns.A2.speaking.narrating_past_experience", "confidence": 0.60, "reason": "Tests past tense narrative with surprise element"}, {"name": "ns.A2.writing.past_tense_narrative", "confidence": 0.90, "reason": "Tests written past tense narrative"}]}
      ],
...
export const getOddOneOutExercise = () => `    {
      ...
      "questions": [
        ...
        {"options": ["quickly", "slowly", "carefully", "fast", "quietly"], "correct_answer": "fast", "nano_skill": [{"name": "ns.A2.vocabulary.adjective_recognition", "confidence": 0.93, "reason": "Tests identifying adjective among -ly adverbs"}]},
        {"options": ["delicious", "tasty", "eat", "spicy", "sweet"], "correct_answer": "eat", "nano_skill": [{"name": "ns.A2.vocabulary.verb_recognition", "confidence": 0.93, "reason": "Tests identifying verb among adjectives"}]},
        {"options": ["waiter", "chef", "serve", "cook", "bartender"], "correct_answer": "serve", "nano_skill": [{"name": "ns.A2.vocabulary.verb_recognition", "confidence": 0.93, "reason": "Tests identifying verb among nouns"}]},
        {"options": ["reservation", "booking", "order", "complain", "menu"], "correct_answer": "complain", "nano_skill": [{"name": "ns.A2.vocabulary.verb_recognition", "confidence": 0.93, "reason": "Tests identifying verb among nouns"}]},
        {"options": ["hot", "cold", "warmth", "fresh", "spicy"], "correct_answer": "warmth", "nano_skill": [{"name": "ns.A2.vocabulary.noun_recognition", "confidence": 0.93, "reason": "Tests identifying noun among adjectives"}]},
        {"options": ["eating", "drinking", "table", "cooking", "serving"], "correct_answer": "table", "nano_skill": [{"name": "ns.A2.vocabulary.noun_recognition", "confidence": 0.93, "reason": "Tests identifying concrete noun among gerunds"}]},
        {"options": ["expensive", "cheap", "beautifully", "fresh", "delicious"], "correct_answer": "beautifully", "nano_skill": [{"name": "ns.A2.vocabulary.adverb_recognition", "confidence": 0.93, "reason": "Tests identifying adverb among adjectives"}]},
        {"options": ["starter", "dessert", "appetizer", "main", "eat"], "correct_answer": "eat", "nano_skill": [{"name": "ns.A2.vocabulary.verb_recognition", "confidence": 0.93, "reason": "Tests identifying verb among nouns"}]},
...
export const getSynonymsExercise = () => `    {
      ...
      "items": [
        ...
        { "term": "popular", "definition": "well-liked", "letter": "D", "nano_skill": [{"name": "ns.A2.synonyms.adjective_synonym.popularity", "confidence": 0.93, "reason": "Tests synonym for popularity descriptor"}]},
        ...
        { "term": "cozy", "definition": "comfortable", "letter": "H", "nano_skill": [{"name": "ns.A2.synonyms.adjective_synonym.comfort", "confidence": 0.93, "reason": "Tests synonym for comfort descriptor"}]},
        { "term": "busy", "definition": "crowded", "letter": "I", "nano_skill": [{"name": "ns.A2.synonyms.adjective_synonym.density", "confidence": 0.93, "reason": "Tests synonym for crowdedness"}]},
        { "term": "excellent", "definition": "outstanding", "letter": "J", "nano_skill": [{"name": "ns.B1.synonyms.adjective_synonym.quality", "confidence": 0.93, "reason": "Tests synonym for high quality"}]}
      ],
...
export const getSentenceTransformationExercise = () => `    {
      ...
      "sentences": [
        ...
        {"original": "I have never eaten such delicious pizza.", "instruction": "Use superlative", "transformed": "This is the most delicious pizza I have ever eaten.", "nano_skill": [{"name": "ns.A2.superlatives.superlative_transformation", "confidence": 0.93, "reason": "Tests transformation to superlative structure"}]},
...
export const getDescribePictureExercise = () => `    {
      ...
      "prompts": [
        {"text": "Describe the overall scene and atmosphere you observe in the image.", "nano_skill": [{"name": "ns.A2.speaking.scene_description", "confidence": 0.40, "reason": "Tests ability to describe visual scenes"}, {"name": "ns.A2.writing.descriptive_response", "confidence": 0.90, "reason": "Tests written descriptive ability"}]},
        {"text": "What specific objects, people, or elements can you identify?", "nano_skill": [{"name": "ns.A2.speaking.object_identification", "confidence": 0.40, "reason": "Tests ability to identify and name visual elements"}, {"name": "ns.A2.writing.listing_from_observation", "confidence": 0.90, "reason": "Tests written listing from visual observation"}]},
        {"text": "What colors, textures, or visual details stand out to you?", "nano_skill": [{"name": "ns.A2.speaking.visual_detail_description", "confidence": 0.40, "reason": "Tests descriptive vocabulary for visual details"}, {"name": "ns.A2.writing.adjective_usage", "confidence": 0.90, "reason": "Tests written adjective usage"}]},
        ...
        {"text": "How would you describe the mood or feeling this image conveys?", "nano_skill": [{"name": "ns.B1.speaking.emotion_expression", "confidence": 0.35, "reason": "Tests expressing mood and atmosphere"}, {"name": "ns.B1.writing.mood_description", "confidence": 0.90, "reason": "Tests written mood description"}]},
        ...
        {"text": "If you were in this scene, what would you notice first?", "nano_skill": [{"name": "ns.B1.speaking.hypothetical_reasoning", "confidence": 0.35, "reason": "Tests hypothetical scenario description"}, {"name": "ns.B1.writing.conditional_response", "confidence": 0.90, "reason": "Tests written conditional response"}]},
        ...
        {"text": "What questions would you ask about what's happening in the picture?", "nano_skill": [{"name": "ns.A2.speaking.question_formation", "confidence": 0.40, "reason": "Tests question formation skills"}, {"name": "ns.A2.writing.question_formation", "confidence": 0.90, "reason": "Tests written question formation"}]},
        {"text": "Compare this scene to a similar one from your own experience.", "nano_skill": [{"name": "ns.B1.speaking.comparison_and_contrast", "confidence": 0.35, "reason": "Tests comparative description skills"}, {"name": "ns.B1.writing.comparative_response", "confidence": 0.90, "reason": "Tests written comparative response"}]}
      ],
...
export const getAnswerQuestionsPictureExercise = () => `    {
      ...
      "questions": [
        ...
        {"question": "How many people can you see in the restaurant? What do you think they are doing?", "focus": "Present continuous and speculation", "nano_skill": [{"name": "ns.A2.speaking.scene_description", "confidence": 0.60, "reason": "Tests scene description with present continuous"}, {"name": "ns.A2.writing.present_continuous_description", "confidence": 0.90, "reason": "Tests written present continuous description"}]},
