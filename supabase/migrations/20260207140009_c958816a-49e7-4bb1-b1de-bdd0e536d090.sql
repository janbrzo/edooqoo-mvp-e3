...
-- ================================================
-- FIX PROBLEM 2: Remove event_type from DELETE (prevents duplicates)
-- FIX PROBLEM 1C: Remove close_tab from CASE WHEN
-- ================================================

-- 1. Update worksheet trigger: remove event_type from DELETE + remove close_tab
...
BEGIN
  -- Determine event_type based on eval_trigger (close_tab REMOVED)
  v_event_type := CASE 
  ...
  -- DELETE existing event for this exercise (ANY event_type - prevents duplicates!)
...
-- 2. Update homework trigger: remove event_type from DELETE + remove close_tab
